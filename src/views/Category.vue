<template>
	...
	<div class="bg-white">
		<div class="my-14 max-w-3xl mx-auto grid grid-cols-1 gap-10 px-6 lg:lg:grid-flow-col-dense lg:grid-cols-4">
...
export default {
	...
	methods: {
		...mapActions('eService', [
			'resetPagination',
			'incrementPage',
			'getEServicesOfCategoryAction',
			'getAvailableEServicesOfCategoryAction',
			'getMostRatedEServicesOfCategoryAction',
			'getFeaturedEServicesOfCategoryAction',
		]),
