			...
			<div class="px-4 py-8 bg-white shadow-xl sm:rounded-lg sm:px-10">
				...
				<form class="space-y-6" @submit.prevent="this.register">
					<div class="mt-1">
						<input
							...
							class="
								...
								shadow-sm
								appearance-none
								focus:outline-none focus:ring-main-color-500 focus:border-main-color-500
								sm:text-sm
							"
							name="name"
							required="required"
					...
					<!-- <div class="flex items-center">
						<input
							id="conditions"
							class="w-4 h-4 rounded border-gray-300 text-main-color-600 focus:ring-main-color-500"
							name="conditions"
							required="required"
							type="checkbox"
						/>
